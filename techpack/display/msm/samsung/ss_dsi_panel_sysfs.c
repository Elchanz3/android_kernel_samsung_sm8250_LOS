...
static DEVICE_ATTR(mask_enable, S_IRUGO | S_IWUSR | S_IWGRP, NULL, ss_finger_hbm_enable_store);
static DEVICE_ATTR(actual_mask_enable, S_IRUGO | S_IWUSR | S_IWGRP, ss_finger_hbm_enable_show, NULL);
...
//	&dev_attr_ldu_correction.attr,
	...
	&dev_attr_actual_mask_enable.attr,
